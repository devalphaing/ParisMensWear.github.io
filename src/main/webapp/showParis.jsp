      ...
      <div class="collapse navbar-collapse" id="navlinks">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="logout" class="nav-link" style="color:blue">
            logout
            </a>
          </li>
        </ul>    
        ...
        <div class="col-md-6 text-center order-1 order-md-2">
          <div class="row justify-content-center">
            <div class="col-10 col-lg-8 blurb mb-5 mb-md-0">
              <h2>For placing order click below:</h2>
              <img src="imgs/lolli_icon.png" alt="" class="d-none d-lg-inline">
              <a href="order.jsp" style="color:blue">
              <p class="lead" style="background-color:black">Order Now</p></a>
              
              Or you can click below to Contact us:
              
              <a href="contact.jsp" style="color:blue">
              <p class="lead" style="background-color:black">Contact</p>
            </div>
          </div>
        </div>
      </div>
